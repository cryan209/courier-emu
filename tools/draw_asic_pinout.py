...
setp(76, 'flash A15 (system A16)', 'mem'); setp(75, 'GND (flash pin 13)', 'pwr')
setp(74, 'flash A16 (system A17)', 'mem'); setp(73, 'flash A17 (system A18)', 'mem')
...
setp(58, 'CPU A19 (CPU 32)', 'mem')
setp(52, 'RESIN out -> R1 -> CPU 68', 'cpu')
setp(51, 'TXD0 (CPU 2)', 'cpu')
setp(50, 'U22 3B', 'pan'); setp(49, 'U22 2A', 'pan'); setp(46, 'U22 1A - RD', 'pan')
setp(48, 'DS1489A U18 4Y', 'pan')
setp(45, 'GND', 'pwr')
...
setp(108, 'DSP D0', 'dsp')
setp(109, 'DSP INT2 (pin 39)', 'dsp')
setp(110, 'GND', 'pwr')
setp(111, 'ADM707 p7 - RESET', 'cpu')
setp(112, 'AC03 codec pin 14', 'dsp')
setp(113, 'DSP TOUT (pin 122)', 'dsp')
setp(114, 'DSP IS', 'dsp')
...
setp(15,'Talk/Data switch','dip'); setp(24,'GND','pwr')
setp(29,'phone header pin 12','tel'); setp(19,'opto U14 p5 (line side)','tel'); setp(22,'opto U16 p5 (line side)','tel')
setp(118,'DIP switch 3','dip')
