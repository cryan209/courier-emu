...
| `U18` | **unidentified**, and the best candidate for the missing **EIA-232 receiver**. ASIC pin 48 goes to its pin 11, which on a 75189 is `4Y`, a receiver output - the right direction and the right neighbourhood. Reading its marking would close the last gap in the DTE interface. See [asic-pinout.md](asic-pinout.md) |
