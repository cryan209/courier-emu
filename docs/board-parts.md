...
| `74VHC573`, `74VHC32`, `74VHC04` | bus glue. The '573 is an **address demultiplex latch**; which half of the bus it latches is unsettled, and whether there is a second one is unknown - the photo this table came from gives no count. See [asic-pinout.md](asic-pinout.md) |
