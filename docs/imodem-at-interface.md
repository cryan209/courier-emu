...
| `ATI7` | configuration profile. The original erased-record sweep reported `Options V32bis,x2,V.90` and no serial. The emulator's default factory record now reports `Options HST,V32bis,Terbo,V.FC,V34+,x2,V.90`, product type, supervisor and DSP dates, and serial `COURIEREMU01`; it also prints `Clock Freq 20.16Mhz`, `Eprom 768k`, `Ram 256k`, `Supervisor rev 3.0.2`, `DSP rev 3.0.5`, and `Product ID 992332-01`. See [imodem-config-sector.md](imodem-config-sector.md) |
